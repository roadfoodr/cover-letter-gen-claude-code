...
5. Verify that sample letters exist in `inputs/sample_letters/`
...
6. Optionally read the previous `outputs/{company}_{date}/cover_letter.md` to understand what's being refined:
...
7. Perform the letter composition according to the skill instructions:
...
8. **Overwrite** the existing files:
   - Write the refined cover letter to `outputs/{company}_{date}/cover_letter.md` (overwrites previous version)
   - Write the updated reasoning document to `outputs/{company}_{date}/reasoning.md` (overwrites previous version)
...
1. Print a summary of the refinement:
   ...
   - Paths to the refined files:
     - `outputs/{company}_{date}/cover_letter.md` (updated)
     - `outputs/{company}_{date}/reasoning.md` (updated)
...
- Only the cover letter and reasoning documents are regenerated
